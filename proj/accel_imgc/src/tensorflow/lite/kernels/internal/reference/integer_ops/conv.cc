...
void ConvPerChannel(
  ...
  // Only first layer has input depth of 3, rest is multiple of 16
  // This can be utilized for hardware acceleration
  if (filter_input_depth % 16 == 0) {
    CFUConvPerChannel(params, output_multiplier, output_shift, input_shape,
