...
#define CFU_MAC_SET_INPUT_VALS(in0) cfu_op0(4, in0, 0)  // Load input_vals into CFU FiFo buffer
#define CFU_MAC_ON_BUFFER(in0) cfu_op0(5, in0, 0)       // Apply filter_vals on the input_vals, which are saved in the CFU input_val FiFo
