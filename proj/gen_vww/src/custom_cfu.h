...
#define CFU_MAC_ON_BUFFER() cfu_op0(5, 0, 0)       // Apply filter_vals on the input_vals, which are saved in the CFU input_val FiFo
#define CFU_MAC_CLEAR_INPUT_VALS() cfu_op0(6, 0, 0)     // Clear the input_val FiFo

#define CFU_MAC_SET_FILTER_VALS(in0, in1) cfu_op0(7, in0, in1)
#define CFU_MAC_NEXT_FILTER_SET() cfu_op0(8, 0, 0)
#define CFU_MAC_CLEAR_FILTER_VALS() cfu_op0(9, 0, 0)
#define CFU_MAC_REWIND_FILTER_SET() cfu_op0(10, 0, 0)
